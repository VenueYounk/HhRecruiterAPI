        ...
        for industry in INDUSTRIES:
            ...
            for page in range(deep):
                ...
                params = {
                    "area": [
                        40,
                    ],  # Замените значение на необходимую вам область (например, Москва - 1)
                    "industry": industry[
                        "id"
                    ],  # Замените значение на необходимую вам отрасль
                    "order_by": "publication_time",  # Замените значение на нужный порядок сортировки
                    "page": page,
                    "per_page": 100,
                }
